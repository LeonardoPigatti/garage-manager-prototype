  ...
  <div class="page">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-sub">Gerencie as informações da sua conta e oficina</p>
      </div>
    </div>
          ...
          <div class="fields-grid">
            <div class="field-group">
              ...
              <div class="field-wrapper">
                ...
                <input v-model="formOficina.nome" class="field-input" :class="{ readonly: !isEditingOficina }" :readonly="!isEditingOficina" placeholder="Nome da oficina"/>
              </div>
            </div>
            ...
            <div class="field-group">
              ...
              <div class="field-wrapper">
                ...
                <input v-model="formOficina.cnpj" class="field-input" :class="{ readonly: !isEditingOficina }" :readonly="!isEditingOficina" placeholder="00.000.000/0000-00" @input="maskCnpj" maxlength="18"/>
              </div>
            </div>
            ...
            <div class="field-group">
              ...
              <div class="field-wrapper">
                ...
                <input v-model="formOficina.telefone" class="field-input" :class="{ readonly: !isEditingOficina }" :readonly="!isEditingOficina" placeholder="(00) 00000-0000" @input="maskPhone" maxlength="15"/>
              </div>
            </div>
            ...
            <div class="field-group full">
              ...
              <div class="field-wrapper">
                ...
                <input v-model="formOficina.endereco" class="field-input" :class="{ readonly: !isEditingOficina }" :readonly="!isEditingOficina" placeholder="Rua, número, bairro, cidade"/>
              </div>
            </div>
          </div>

          <div v-if="isEditingOficina" class="edit-actions">
            <button class="btn-cancel" @click="cancelEditOficina">Cancelar</button>
      ...
      <div class="form-section">
        <div class="section-header">
          ...
          <div>
            ...
            <span class="section-sub">Informações do seu usuário</span>
          </div>
        ...
        <div class="fields-grid">
          <div class="field-group full">
            ...
            <div class="field-wrapper">
              ...
              <input v-model="formUser.email" class="field-input" :class="{ readonly: !isEditingUser }" :readonly="!isEditingUser" placeholder="seu@email.com" type="email"/>
            </div>
          </div>
          ...
          <template v-if="isEditingUser">
            <div class="field-group">
              <label class="field-label">Nova senha <span class="optional">(opcional)</span></label>
              <div class="field-wrapper">
        ...
        <div v-if="isEditingUser" class="edit-actions">
          <button class="btn-cancel" @click="cancelEditUser">Cancelar</button>
